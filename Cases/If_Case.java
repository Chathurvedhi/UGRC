...
public class If_Case {
    ...
    {   
        ...
        // Var Set: {mainlist}; Ref Set: {O1, O2, O7, O5, O6, O3, O4}
...
Call 1:
    ...
    public static void AllocPair1(PairList ml, int n)
    {
        ...
        if (n == 0)
        {
            ...
            // Var Set: {ml, p1}; Ref Set: {O1, O2, O3, O4, O5, O6}
        }
        else
        {
            // Var Set: {ml, p1, p2}; Ref Set: {O1, O2, O3, O4, O5, O6}
        ...
        // Var Set: {ml}; Ref Set: {O1, O2, O3, O4, O5, O6}
    }   
...
Call 4:
    ...
    public static void PrintPair1(PairList ml)
    {
        ...
        // Var Set: {ml, p}; Ref Set: {O1, O2, O3, O4, O5, O6}
        
        Node l = p.left;    // Stack = {(ml, O1), (p, O5,O6), (l, O2,O3)}, Heap = {(O5, left, O2), (O5, right, O3), (O6, left, O3), (O6, right, O4), (O1, pair1, O5,O6), (O1, pair2, O5)}
        
        // Var Set: {ml, l, p}; Ref Set: {O1, O2, O3, O4, O5, O6}
        
        Node r = p.right;   // Stack = {(ml, O1), (p, O5,O6), (l, O2,O3), (r, O3,O4)}, Heap = {(O5, left, O2), (O5, right, O3), (O6, left, O3), (O6, right, O4), (O1, pair1, O5,O6), (O1, pair2, O5)}
        
        // Var Set: {ml, l, r}; Ref Set: {O1, O2, O3, O4, O5, O6}
        
        System.out.println(l.data); // Stack = {(ml, O1), (p, O5,O6), (l, O2,O3), (r, O3,O4)}, Heap = {(O5, left, O2), (O5, right, O3), (O6, left, O3), (O6, right, O4), (O1, pair1, O5,O6), (O1, pair2, O5)}
        
        // Var Set: {ml, r}; Ref Set: {O1, O2, O3, O4, O5, O6}
...
Call 5:
    ...
    public static void Modify(PairList ml)
    {
        // Base Stack = {ml, O1)}, Heap = {(O1, pair1, O5,O6), (O1, pair2, O5), (O5, left, O2), (O5, right, O3), (O6, left, O3), (O6, right, O4)}

        // Var Set: {ml}; Ref Set: {O1, O2, O3, O4, O5, O6}
        
        Pair p = ml.pair1;  // Stack = {(ml, O1), (p, O5,O6)}, Heap = {(O1, pair1, O5,O6), (O1, pair2, O5), (O5, left, O2), (O5, right, O3), (O6, left, O3), (O6, right, O4)}

        // Var Set: {ml}; Ref Set: {O1, O2, O5, O6, O3, O4}
        ...
        // Var Set: {temp, ml}; Ref Set = {O1, O2, O7, O5, O6, O3, O4}
        ...
        // Var Set: {ml}; Ref Set: {O1, O2, O7, O5, O6, O3, O4}
    }
*/
...
Call 6:
    ...
    public static void PrintPair1(PairList ml)
    {
        ...
        // Var Set: {p}; Ref Set: {O2, O7, O5, O6, O3, O4}
        
        Node l = p.left;    // Stack = {(ml, O1), (p, O5,O6), (l, O2,O3,O7)}, Heap = {(O1, pair1, O5,O6), (O1, pair2, O5), (O5, left, O2,O7), (O5, right, O3), (O6, left, O3,O7), (O6, right, O4)}
        
        // Var Set: {p, l}; Ref Set: {O2, O7, O5, O6, O3, O4}
        ...
        // Var Set: {r, l}; Ref Set: {O2, O3, O4, O7}
